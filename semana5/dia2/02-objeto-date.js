// La clse Date sirve para manipular fechas
...
//getMonth();
//retorna el número del mes iniciando en 0
...
//restando fechas
console.log("fiestas patrias menos hoy", fiestasPatrias);

const milisegundos = fiestasPatrias - hoy;
const diasPara28Julio = milisegundos / 1000 / 60 / 60 / 24;
console.log("dias para 28 Julio", diasPara28Julio);
