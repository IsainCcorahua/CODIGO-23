const peliculas = [
    [
		...
		},
		{
			...
			"overview": "A principios del siglo XIX, el pugilismo era el deporte de los reyes y un talentoso joven boxeador luchó para convertirse en campeón de Inglaterra.",
			"popularity": 1635.927,
		...
		},
		{
			...
			"overview": "Sayen, una mujer mapache, descubre una peligrosa conspiración liderada por una corporación que está destruyendo las tierras de su familia y destruyendo los ecosistemas locales en toda América Latina. Sayen tendrá la tarea de llevar el caso ante la justicia y salvar el legado de su familia. Primera entrega de una trilogía.",
			"popularity": 1052.037,
		...
		},
		{
			...
			"overview": "Tras participar en una sesión de espiritismo, la joven Laura comienza a comportarse de manera extraña. Alarmados, sus padres piden ayuda al padre Olmedo, uno de los pocos exorcistas autorizados por el Vaticano para intervenir en casos de posesiones demoníacas.",
			"popularity": 890.798,
		...
		},
		{
			...
			"overview": "Hace décadas, la URSS desarrolló tiburones imposibles de matar y los lanzó a la luna. Hoy, un equipo de astronautas estadounidenses enfrentará la lucha de sus vidas.",
			"popularity": 925.584,
		...
		},
		{
			...
			"overview": "El cómico estadounidense Kevin Hart quiere ser una estrella de acción, pero para conseguir un papel que cambie su vida, primero tiene que aprender a ser un héroe de acción.",
			"popularity": 931.464,
		...
		},
		{
			...
			"overview": "Después del presunto suicidio de su hermano sacerdote, Grace viaja al remoto convento escocés donde cayó y murió. Desconfiando del relato de la Iglesia, descubre un asesinato, un sacrilegio y una inquietante verdad sobre sí misma.",
			"popularity": 1119.737,
		...
		},
		{
			...
			"overview": "Un ingeniero en robótica de una empresa de juguetes construye una muñeca realista que comienza a cobrar vida propia.",
			"popularity": 790.418,
...
//ejercicio 1
//funcion que retorna el numero total de peliculas
function totalDePeliculas() {
    return(peliculas.length);
}

console.log("Total de peliculas son: ", totalDePeliculas());

//ejercicio 2
//funcion que devuelve el nombre de la pelicula con mayor popularidad
//HINT:
//campo a analizar _popularity_
//iterar todas las peliculas guardando:
//1. el index o posicion de las peliculas con mayor popularidad
...
console.log("Peliculas más popular", peliculaConMayorPopularidad());

//Ejercicio 3:
//Funcion que retorna el nombre de la pelicula con más generos

function peliculaConMasGeneros(){
    let MasGeneros=0;
    let posicionMG=-1;
    for (let i=0;i<peliculas.length;i++){
        if (peliculas[i].genre_ids > MasGeneros)
        MasGeneros=peliculas[i].genre_ids;
        posicionMG=i;
    }

    return peliculas[posicionMG].title
}
console.log("Pelicula con más generos", peliculaConMasGeneros());

//Ejercicio 4:
//Funcion que inprime los generos a los que pertenece la primera pelicula
//Es decir, la pelicula de la posicion 0
